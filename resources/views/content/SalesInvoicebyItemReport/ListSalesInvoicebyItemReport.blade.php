...
<script>
    function reset_add(){
		$.ajax({
				type: "GET",
				url : "{{route('filter-reset-sales-invoice-by-item-report')}}",
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Laporan Penjualan Barang</li>
    </ol>
</nav>
...
<br/>
<div id="accordion">
    <form  method="post" action="{{ route('filter-sales-invoice-by-item-report') }}" enctype="multipart/form-data">
    @csrf
...
<div class="card border border-dark">
  <div class="card-header bg-dark clearfix">
    ...
    <div class="card-footer text-muted">
        <div class="form-actions float-right">
            <a class="btn btn-danger" href="/sales-invoice-by-item-report/print"> Preview</a>
            <a class="btn btn-primary" href="/sales-invoice-by-item-report/export"><i class="fa fa-download"></i> Export Data</a>
        </div>
    </div>
  </div>
</div>
