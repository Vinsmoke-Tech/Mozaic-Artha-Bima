...
<div class="card border border-dark">
  <div class="card-header bg-dark clearfix">
            ...
            <table id="" style="width:100%" class="table table-striped table-bordered table-hover table-full-width">
                <thead>
                    <tr>
                        ...
                        <th width="5%" rowspan="2" style="vertical-align : middle;text-align:center;">Aksi</th>
                    </tr>
                </thead>
                <tbody>
                   <?php 
                   ...
                   @foreach ($data as $row)
                    <tr>
                        ...
                        <th style="text-align: center">
                            <a href="{{route('delete-cash-disbursement-report', ['expenditure_id' => $row['expenditure_id']])}}" name='Reset' class='btn btn-outline-danger btn-sm' onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data Ini ?')"></i> Hapus</a>
                        </th>
                    </tr>
                       <?php $total_amount += $row['expenditure_amount'] ?>
                   @endforeach
                   <tr>
                    <th style="text-align: center" colspan="3">Total Pengeluaran Kas</th>
    ...
    <div class="card-footer text-muted">
        <div class="form-actions float-right">
            <a class="btn btn-danger" href="/cash-disbursement-report/print"> Preview</a>
            <a class="btn btn-primary" href="/cash-disbursement-report/export"><i class="fa fa-download"></i> Export Data</a>
        </div>
    </div>
  </div>
</div>
