    ...
    <form method="post" action="{{ route('process-add-journal-voucher') }}" enctype="multipart/form-data">
            ...
            <div class="row form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::select('account_id',  $account    , 0, ['class' => 'selection-search-clear select-form', 'id' => 'account_id']) !!}
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <a class="text-dark">D/K<a class='red'> *</a></a>
                        {!! Form::select(0,  $status, 0, ['class' => 'selection-search-clear select-form', 'id' => 'account_status']) !!}
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
        ...
        <div class="card-footer text-muted">
            <div class="form-actions float-right">
                <a onclick="processAddArrayJournalVoucher()" class="btn btn-primary" title="Add">Tambah</a>
            </div>
        </div>       
</div>
