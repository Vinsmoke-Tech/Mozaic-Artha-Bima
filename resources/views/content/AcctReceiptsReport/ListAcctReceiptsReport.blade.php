...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Laporan Penerimaan Kas </li>
    </ol>
  </nav>
...
<h3 class="page-title">
    <b>Laporan Penerimaan Kas </b>
</h3>
<br/>
<div id="accordion">
    <form  method="post" action="{{ route('fiter-cash-receipts-report') }}" enctype="multipart/form-data">
    @csrf
        ...
        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
            ...
            <div class="card-footer text-muted">
                <div class="form-actions float-right">
                    <a href="{{ route('reset-filter-cash-receipts-report') }}" type="reset" name="Reset" class="btn btn-danger"><i class="fa fa-times"></i> Batal</a>
...
<div class="card border border-dark">
  <div class="card-header bg-dark clearfix">
                ...
                <tbody>
                   ...
                   @foreach ($data as $row)
                       <tr>
                        ...
                        <td style="text-align: right">{{ number_format($row['journal_voucher_amount'],2,'.',',') }}</td>
                       </tr>
                       <?php $total_amount += $row['journal_voucher_amount'] ?>
                   @endforeach
                   <tr>
                    <th style="text-align: right" colspan="3">Total Penerimaan Kas</th>
    ...
    <div class="card-footer text-muted">
        <div class="form-actions float-right">
            <a class="btn btn-danger" href="/cash-receipts-report/print"> Preview</a>
            <a class="btn btn-primary" href="/cash-receipts-report/export"><i class="fa fa-download"></i> Export Data</a>
        </div>
    </div>
  </div>
</div>
